...
import { FiShoppingCart, FiHeart, FiShield, FiTruck, FiRotateCcw, FiChevronRight, FiZoomIn } from 'react-icons/fi';
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-16 xl:gap-24">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6 lg:sticky lg:top-24 h-fit">
            ...
            <div 
              ...
              onClick={() => openLightbox(displayImages.indexOf(activeImage) || 0)}
            >
              <img 
                src={activeImage} 
                alt={product.name} 
        ...
        <div className="fixed inset-0 bg-black/95 z-[100] flex items-center justify-center p-4">
          <div className="relative w-full h-full max-w-5xl mx-auto flex items-center justify-center">
            ...
            <button
              ...
              className="absolute top-6 right-6 text-white hover:text-gray-300 z-10 p-3 text-4xl"
            >
              ✕
            </button>
            ...
            {displayImages.length > 1 && (
              <button
                ...
                className="absolute left-6 text-white hover:text-gray-300 bg-black/30 hover:bg-black/50 p-4 rounded-full transition-all text-3xl"
              >
                ←
              </button>
            )}
            ...
            {displayImages.length > 1 && (
              <button
                onClick={goToNext}
                className="absolute right-6 text-white hover:text-gray-300 bg-black/30 hover:bg-black/50 p-4 rounded-full transition-all text-3xl"
              >
                →
              </button>
            )}
